...
RSpec.describe Application::Elements::Button::Edit do
  it "renders the Edit button" do
    result = render_inline(Application::Elements::Button::Edit.new(url: "#"))
  ...
  it "renders the Edit button with a custom name" do
    result = render_inline(Application::Elements::Button::Edit.new(url: "#", name: "Custom name"))
  ...
  it "renders the Edit button without icon" do
    result = render_inline(Application::Elements::Button::Edit.new(url: "#", icon: false))
  ...
  it "renders the Edit button with a custom icon" do
    result = render_inline(Application::Elements::Button::Edit.new(url: "#", icon: 'test'))
