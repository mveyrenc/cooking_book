...
RSpec.describe Application::Elements::ButtonMoveUpComponent do
  it "renders the MoveUp button" do
    result = render_inline(Application::Elements::ButtonMoveUpComponent.new(url: "#"))
  ...
  it "renders the MoveUp button with a custom name" do
    result = render_inline(Application::Elements::ButtonMoveUpComponent.new(url: "#", name: "Custom name"))
  ...
  it "renders the MoveUp button without icon" do
    result = render_inline(Application::Elements::ButtonMoveUpComponent.new(url: "#", icon: false))
  ...
  it "renders the MoveUp button with a custom icon" do
    result = render_inline(Application::Elements::ButtonMoveUpComponent.new(url: "#", icon: 'test'))
