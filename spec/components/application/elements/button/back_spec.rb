...
RSpec.describe Application::Elements::Button::Back do
  it "renders the back button" do
    result = render_inline(Application::Elements::Button::Back, url: "#")
  ...
  it "renders the back button with a custom name" do
    result = render_inline(Application::Elements::Button::Back, url: "#", name: "Custom name")
  ...
  it "renders the back button without icon" do
    result = render_inline(Application::Elements::Button::Back, url: "#", icon: false)
  ...
  it "renders the back button with a custom icon" do
    result = render_inline(Application::Elements::Button::Back, url: "#", icon: 'test')
