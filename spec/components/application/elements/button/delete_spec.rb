...
RSpec.describe Application::Elements::Button::Delete do
  it "renders the Delete button" do
    result = render_inline(Application::Elements::Button::Delete.new(url: "#"))
  ...
  it "renders the Delete button with a custom name" do
    result = render_inline(Application::Elements::Button::Delete.new(url: "#", name: "Custom name"))
  ...
  it "renders the Delete button without icon" do
    result = render_inline(Application::Elements::Button::Delete.new(url: "#", icon: false))
  ...
  it "renders the Delete button with a custom icon" do
    result = render_inline(Application::Elements::Button::Delete.new(url: "#", icon: 'test'))
